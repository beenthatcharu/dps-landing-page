  ...
  return (
    <Card className="w-full bg-white/95 backdrop-blur-md text-foreground shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] border border-white/50 overflow-hidden rounded-[2.5rem]">
      ...
      <CardHeader className="space-y-3 p-10 pb-4">
        <CardTitle className="text-3xl font-black font-headline text-primary tracking-tight">Admission Enquiry</CardTitle>
        <CardDescription className="text-muted-foreground/80 text-base font-medium">
          Step 1: Basic Information (Academic Year 2026-27)
        </CardDescription>
      </CardHeader>
        ...
        <form onSubmit={handleSend} className="space-y-6">
          <div className="grid grid-cols-1 gap-5">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/40 ml-1">Parent's Full Name</Label>
              <Input
                id="fullName"
            ...
            <div className="space-y-2">
              <Label htmlFor="childName" className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/40 ml-1">Name of Child</Label>
              <Input
                id="childName"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/40 ml-1">Email Address</Label>
              <Input
                id="email"
                type="email"
            ...
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/40 ml-1">Phone Number</Label>
              <Input
                id="phone"
                type="tel"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              <Label className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/40 ml-1">Campus Preference</Label>
            ...
            <div className="space-y-2">
              <Label className="text-[10px] uppercase tracking-[0.2em] font-black text-primary/40 ml-1">Applying for Grade</Label>
          ...
          <motion.div
            ...
            className="pt-2"
          >
            <Button type="submit" className="w-full bg-accent hover:bg-accent/90 text-white font-black h-16 text-lg rounded-2xl shadow-[0_20px_40px_-10px_rgba(var(--accent),0.4)] transition-all flex items-center justify-center">
